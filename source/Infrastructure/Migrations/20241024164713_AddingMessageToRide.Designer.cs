...
namespace Infrastructure.Migrations
{
    ...
    [Migration("20241024164713_AddingMessageToRide")]
    partial class AddingMessageToRide
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("DriverVehicle", b =>
                {
                    ...
                    b.Property<int>("_vehiclesId")
                        .HasColumnType("INTEGER");

                    b.HasKey("DriversId", "_vehiclesId");
            ...
            modelBuilder.Entity("DriverVehicle", b =>
                {
                    b.HasOne("Domain.Classes.Driver", null)
                        .WithMany()
                        .HasForeignKey("DriversId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Domain.Classes.Vehicle", null)
                        .WithMany()
                        .HasForeignKey("_vehiclesId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                });
